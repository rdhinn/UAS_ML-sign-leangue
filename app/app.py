...
# ─── PAGE 2: WEBCAM DEMO ───────────────────────────────
    ...
    webrtc_streamer(
        key="asl-webcam", mode=WebRtcMode.SENDRECV,
        rtc_configuration=RTC_CONFIG,
        media_stream_constraints={"video": {"width": {"ideal": 640}, "height": {"ideal": 480}}, "audio": False},
        video_processor_factory=ASLProcessor, async_processing=True,
    )
    st.info("Prediksi langsung di video — tidak perlu klik tombol.")
